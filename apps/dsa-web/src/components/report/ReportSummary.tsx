 ...
 * Renders the report with main content first and transparency / traceability info last.
 */
export const ReportSummary: React.FC<ReportSummaryProps> = ({
  ...
  // Accept either an AnalysisResult or an AnalysisReport shape.
  const report: AnalysisReport = 'report' in data ? data.report : data;
  // Use the report id: queryId may collide in batch analyses, and the history-detail
  // endpoint requires recordId to fetch related news and detail data.
  ...
  return (
    <div className="space-y-5 pb-8 animate-fade-in">
      {/* Overview region (above the fold) */}
      <ReportOverview
        meta={meta}
        summary={summary}
        details={details}
      ...
      {/* Strategy and price levels */}
      <ReportStrategy strategy={strategy} language={reportLanguage} />

      {/* News section */}
      <ReportNews recordId={recordId} limit={8} language={reportLanguage} />

      {/* Low-sensitivity summary of the input data blocks */}
      ...
      {/* Model attribution marker (Issue #528) — shown at the end of the report */}
      {shouldShowModel && (
