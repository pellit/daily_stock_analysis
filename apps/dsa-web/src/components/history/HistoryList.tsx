...
interface HistoryListProps {
  ...
  isDeleting?: boolean;
  onItemClick: (recordId: number) => void;  // Callback fired when an item is clicked.
  onLoadMore: () => void;
 ...
 * Built with the new design-system components, supports batch selection and scroll-to-load.
 */
