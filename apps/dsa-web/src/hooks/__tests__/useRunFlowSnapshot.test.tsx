        ...
        },
        {
          ...
          metadata: {
            ...
            node: {
              ...
              lane: 'data_source',
              kind: 'data_source',
              label: 'Daily candle · DailyFetcher',
              status: 'running',
              provider: 'DailyFetcher',
        ...
        },
        {
          ...
          metadata: {
            ...
            node: {
              ...
              lane: 'data_source',
              kind: 'data_source',
              label: 'Daily candle · PrimaryDaily',
              status: 'failed',
              provider: 'PrimaryDaily',
              durationMs: 120,
        ...
        },
        {
          ...
          metadata: {
            ...
            node: {
              ...
              lane: 'data_source',
              kind: 'data_source',
              label: 'News sentiment · NewsFetcher',
              status: 'success',
              provider: 'NewsFetcher',
