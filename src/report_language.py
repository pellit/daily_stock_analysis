...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "markdown_metric_header": "指标",
        "markdown_value_header": "数值",
        "markdown_core_points_label": "🎯 核心看点",
        "markdown_buy_reason_label": "💡 操作理由",
        "markdown_trend_section_heading": "📉 走势分析",
        "markdown_short_term_outlook_label": "短期（1-3日）",
        "markdown_medium_term_outlook_label": "中期（1-2周）",
        "markdown_outlook_section_heading": "🔮 市场展望",
        "markdown_technical_summary_label": "综合",
        "markdown_ma_label": "均线",
        "markdown_volume_label": "量能",
        "markdown_pattern_label": "形态",
        "markdown_technical_section_heading": "📊 技术面分析",
        "markdown_sector_position_label": "板块地位",
        "markdown_company_highlights_label": "公司亮点",
        "markdown_fundamental_section_heading": "🏢 基本面分析",
        "markdown_news_summary_label": "新闻摘要",
        "markdown_market_sentiment_label": "市场情绪",
        "markdown_hot_topics_label": "相关热点",
        "markdown_news_section_heading": "📰 消息面/情绪面",
        "markdown_summary_section_heading": "📝 综合分析",
        "markdown_risk_warning_label": "⚠️ 风险提示",
        "markdown_search_performed_label": "🔍 已执行联网搜索",
        "markdown_data_sources_label": "📋 数据来源",
        "markdown_error_message_label": "❌ 分析异常",
        "markdown_ideal_buy_prefix": "理想买入点",
        "markdown_secondary_buy_prefix": "次优买入点",
        "markdown_stop_loss_prefix": "止损位",
        "markdown_take_profit_prefix": "目标位",
        "channel_wechat": "企业微信",
        "channel_feishu": "飞书",
        "channel_dingtalk": "钉钉",
        ...
        "channel_serverchan3": "Server酱3",
        "channel_custom": "自定义Webhook",
        "channel_discord": "Discord机器人",
        "channel_slack": "Slack",
        "channel_astrbot": "ASTRBOT机器人",
        "channel_unknown": "未知渠道",
        "sender_report_title": "股票智能分析报告",
        "sender_report_title_short": "股票分析报告",
        "sender_default_sender_name": "daily_stock_analysis股票分析助手",
        "sender_email_fallback_name": "股票分析助手",
        "sender_email_alt_text": "报告已生成，详见下方图片。",
        "sender_email_alt_text_html": "报告已生成，详见下方图片（点击可查看大图）：",
        "sender_email_image_alt": "股票分析报告",
        "sender_email_image_alt_html": "股票分析报告",
        "sender_discord_username": "A股分析机器人",
        "sender_feishu_file_label": "文件",
        "sender_dingtalk_default_title": "通知 (Notification)",
        "sender_unknown_error": "未知错误",
    },
    "en": {
        ...
        "markdown_metric_header": "Metric",
        "markdown_value_header": "Value",
        "markdown_core_points_label": "🎯 Key Highlights",
        "markdown_buy_reason_label": "💡 Trade Rationale",
        "markdown_trend_section_heading": "📉 Trend Analysis",
        "markdown_short_term_outlook_label": "Short-term (1-3 days)",
        "markdown_medium_term_outlook_label": "Medium-term (1-2 weeks)",
        "markdown_outlook_section_heading": "🔮 Market Outlook",
        "markdown_technical_summary_label": "Summary",
        "markdown_ma_label": "MA",
        "markdown_volume_label": "Volume",
        "markdown_pattern_label": "Pattern",
        "markdown_technical_section_heading": "📊 Technical Analysis",
        "markdown_sector_position_label": "Sector Position",
        "markdown_company_highlights_label": "Company Highlights",
        "markdown_fundamental_section_heading": "🏢 Fundamentals",
        "markdown_news_summary_label": "News Summary",
        "markdown_market_sentiment_label": "Market Sentiment",
        "markdown_hot_topics_label": "Related Topics",
        "markdown_news_section_heading": "📰 News & Sentiment",
        "markdown_summary_section_heading": "📝 Summary",
        "markdown_risk_warning_label": "⚠️ Risk Warning",
        "markdown_search_performed_label": "🔍 Web search performed",
        "markdown_data_sources_label": "📋 Data Sources",
        "markdown_error_message_label": "❌ Analysis Error",
        "markdown_ideal_buy_prefix": "Ideal Entry",
        "markdown_secondary_buy_prefix": "Secondary Entry",
        "markdown_stop_loss_prefix": "Stop Loss",
        "markdown_take_profit_prefix": "Target",
        ...
        "channel_gotify": "Gotify",
        "channel_pushplus": "PushPlus",
        "channel_serverchan3": "Server Chan 3",
        "channel_custom": "Custom Webhook",
        "channel_discord": "Discord Bot",
        "channel_slack": "Slack",
        "channel_astrbot": "ASTRBOT Bot",
        "channel_unknown": "Unknown Channel",
        "sender_report_title": "AI Stock Analysis Report",
        "sender_report_title_short": "Stock Analysis Report",
        "sender_default_sender_name": "daily_stock_analysis Stock Analysis Assistant",
        "sender_email_fallback_name": "Stock Analysis Assistant",
        "sender_email_alt_text": "Report generated. See the image below for details.",
        "sender_email_alt_text_html": "Report generated. Click the image below to view the full size:",
        "sender_email_image_alt": "Stock Analysis Report",
        "sender_email_image_alt_html": "Stock Analysis Report",
        "sender_discord_username": "A-Stock Analysis Bot",
        "sender_feishu_file_label": "file",
        "sender_dingtalk_default_title": "Notification",
        "sender_unknown_error": "Unknown error",
    },
    "ko": {
        ...
        "markdown_metric_header": "지표",
        "markdown_value_header": "값",
        "markdown_core_points_label": "🎯 핵심 포인트",
        "markdown_buy_reason_label": "💡 매매 근거",
        "markdown_trend_section_heading": "📉 추세 분석",
        "markdown_short_term_outlook_label": "단기 (1-3일)",
        "markdown_medium_term_outlook_label": "중기 (1-2주)",
        "markdown_outlook_section_heading": "🔮 시장 전망",
        "markdown_technical_summary_label": "종합",
        "markdown_ma_label": "이동평균",
        "markdown_volume_label": "거래량",
        "markdown_pattern_label": "패턴",
        "markdown_technical_section_heading": "📊 기술 분석",
        "markdown_sector_position_label": "섹터 위치",
        "markdown_company_highlights_label": "회사 하이라이트",
        "markdown_fundamental_section_heading": "🏢 펀더멘털",
        "markdown_news_summary_label": "뉴스 요약",
        "markdown_market_sentiment_label": "시장 심리",
        "markdown_hot_topics_label": "관련 이슈",
        "markdown_news_section_heading": "📰 뉴스/심리",
        "markdown_summary_section_heading": "📝 종합 분석",
        "markdown_risk_warning_label": "⚠️ 리스크 경고",
        "markdown_search_performed_label": "🔍 검색 수행",
        "markdown_data_sources_label": "📋 데이터 출처",
        "markdown_error_message_label": "❌ 분석 오류",
        "markdown_ideal_buy_prefix": "이상적 진입",
        "markdown_secondary_buy_prefix": "차선 진입",
        "markdown_stop_loss_prefix": "손절",
        "markdown_take_profit_prefix": "목표",
        "channel_wechat": "WeChat Work",
        "channel_feishu": "Feishu",
        "channel_dingtalk": "DingTalk",
        "channel_telegram": "Telegram",
        ...
        "channel_pushplus": "PushPlus",
        "channel_serverchan3": "Server酱3",
        "channel_custom": "사용자 정의 Webhook",
        "channel_discord": "Discord 봇",
        "channel_slack": "Slack",
        "channel_astrbot": "ASTRBOT 봇",
        "channel_unknown": "알 수 없는 채널",
        "sender_report_title": "AI 주식 분석 리포트",
        "sender_report_title_short": "주식 분석 리포트",
        "sender_default_sender_name": "daily_stock_analysis 주식 분석 어시스턴트",
        "sender_email_fallback_name": "주식 분석 어시스턴트",
        "sender_email_alt_text": "보고서가 생성되었습니다. 자세한 내용은 아래 이미지를 확인하세요.",
        "sender_email_alt_text_html": "보고서가 생성되었습니다. 전체 보기를 클릭하세요:",
        "sender_email_image_alt": "주식 분석 리포트",
        "sender_email_image_alt_html": "주식 분석 리포트",
        "sender_discord_username": "A주식 분석 봇",
        "sender_feishu_file_label": "파일",
        "sender_dingtalk_default_title": "알림 (Notification)",
        "sender_unknown_error": "알 수 없는 오류",
    },
}
